...
def register_handler(message):
    if not check_chat_id_from_csv("bot/chats.csv", message.chat.id):
...
def get_trello_username(message):
    write_chat_to_csv("bot/chats.csv", message)
...
def get_boards(message):
    if not check_chat_id_from_csv("bot/chats.csv", message.chat.id):
        ...
        trello_username = get_trello_username_by_chat_id("bot/chats.csv", message.chat.id)
        if trello_username:
            bot.send_message(
